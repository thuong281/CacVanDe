...
public class MainActivity extends AppCompatActivity implements StaggeredRVAdapter.ClickListener {
    ...
    private void initLessons(){
        ...
        List<Group> listLesson1 = new ArrayList();

        listLesson1.add(groupMacLuoi);
        listLesson1.add(groupVongTron);
        listLesson1.add(groupHoiVan);

        lesson1.setGroups(listLesson1);
        lessons.add(lesson1);

        Lesson lesson2= new Lesson("Bài 2: Họa tiết chữ", R.drawable.p41);
        Group group2= new Group("");
        group2.getItems().add("Trong Hán tự có nhiều chữ tượng ý dù rằng thuở ban đầu chữ Hán là hình vẽ dùng để chỉ " +
        ...
        group2.getItems().add("Chữ hiện nay khác rất xa với chữ cổ, tác dụng trang trí thêm nhiều hơn. Hoặc mềm mại " +
        ...
        group2.getItems().add("Tên các tấm giấy to lại thấy có tác dụng khác: nghệ thuật mang nét phóng khoáng. Người " +
                ...
                "đang suy tàn.");
        group2.getItems().add("Trong các trường hợp này mục đích trang trí là thứ yếu. Điều mà người ta muốn nói lên " +
                "trước tiên là tư duy: người nghệ sĩ làm sao cho chữ viết thanh cao nhất.");
        group2.getItems().add("Nhưng đối với một số chữ, mục đích trang trí có tính nhạy cảm hơn như chữ ‘phúc’, chữ " +
        ...
        group2.getItems().add("Thường chữ ‘thọ’ được dùng nhiều và rất đa dạng. Nhiều người An Nam, trong đó có cả " +
        ...
        group2.getItems().add(new Picture(R.drawable.p36, "Hình 36"));
        group2.getItems().add(new Picture(R.drawable.p37, "Hình 37"));
        group2.getItems().add(new Picture(R.drawable.p38, "Hình 38"));
        group2.getItems().add(new Picture(R.drawable.p39, "Hình 39"));
        group2.getItems().add(new Picture(R.drawable.p40, "Hình 40"));
        group2.getItems().add(new Picture(R.drawable.p41, "Hình 41"));
        group2.getItems().add(new Picture(R.drawable.p42, "Hình 42"));
        group2.getItems().add(new Picture(R.drawable.p43, "Hình 43"));
        group2.getItems().add(new Picture(R.drawable.p44, "Hình 44"));
        group2.getItems().add(new Picture(R.drawable.p45, "Hình 45"));
        group2.getItems().add(new Picture(R.drawable.p46, "Hình 46"));
        group2.getItems().add(new Picture(R.drawable.p47, "Hình 47"));
        group2.getItems().add(new Picture(R.drawable.p48, "Hình 48"));
        group2.getItems().add(new Picture(R.drawable.p49, "Hình 49"));
        group2.getItems().add(new Picture(R.drawable.p50, "Hình 50"));
        group2.getItems().add(new Picture(R.drawable.p51, "Hình 51"));
        group2.getItems().add("Có một chữ rất đặc thù là chữ ‘hỉ’. Một đôi khi nó được dùng một mình nhưng thường " +
                ...
                "cưới.");
        group2.getItems().add(new Picture(R.drawable.p52, "Hình 52"));
        group2.getItems().add(new Picture(R.drawable.p53, "Hình 53"));
        List<Group> listLesson2 = new ArrayList();
        listLesson2.add(group2);
        lesson2.setGroups(listLesson2);
        lessons.add(lesson2);


        Lesson lesson3 = new Lesson("Bài 3: Họa tiết hình tĩnh vật", R.drawable.hinhtinhvat);
        Group group3= new Group("");
        group3.getItems().add("Nhiều món tĩnh vật đã đi vào họa tiết trang trí của người An Nam. Hồi văn hình kệ trên " +
                "doanh liên (cặp biển câu đối) chúng ta đã thấy ở hình XXXV là một ví dụ.");
        group3.getItems().add("Trên cao đề kỷ (món đồ gỗ có dạng hồi văn) người nghệ sĩ đặt trên đó những món đồ thờ, " +
                ...
                "chúng bên");
        group3.getItems().add(new Picture(R.drawable.p54, "Hình 54"));
        group3.getItems().add(new Picture(R.drawable.p55, "Hình 55"));
        group3.getItems().add(new Picture(R.drawable.p56, "Hình 56"));
        group3.getItems().add(new Picture(R.drawable.p57, "Hình 57"));
        group3.getItems().add("Cuốn thư có công dụng lớn. Về nguyên tắc đó là một cuộn giấy giỡ ra nửa chừng, hai đầu " +
        ...
        group3.getItems().add(new Picture(R.drawable.p58, "Hình 58"));
        group3.getItems().add(new Picture(R.drawable.p59, "Hình 59"));
        group3.getItems().add(new Picture(R.drawable.p60, "Hình 60"));
        group3.getItems().add("Hỏa châu (tráu châu, quả châu) thường thấy ở chính giữa gờ nóc đền chùa. Mô-típ thông " +
        ...
        group3.getItems().add(new Picture(R.drawable.p61, "Hình 61"));
        group3.getItems().add(new Picture(R.drawable.p62, "Hình 62"));
        group3.getItems().add(new Picture(R.drawable.p63, "Hình 63"));
        group3.getItems().add(new Picture(R.drawable.p64, "Hình 64"));
        group3.getItems().add(new Picture(R.drawable.p65, "Hình 65"));
        group3.getItems().add("Trên gờ nóc mái có khi thay thế hỏa châu bằng trái bầu, trường hợp này chí thấy chùa " +
        ...
        group3.getItems().add(new Picture(R.drawable.p66, "Hình 66"));
        group3.getItems().add(new Picture(R.drawable.p67, "Hình 67"));
        group3.getItems().add(new Picture(R.drawable.p68, "Hình 68"));
        group3.getItems().add("Đôi chỗ họa tiết thể hiện nhiều hình tĩnh vật, thường thấy nhất là ‘bát bửu’, ở đòn tay, ở " +
        ...
        group3.getItems().add("Còn đây là bát bảo theo Trung Hoa, thấy chẳng khác gì của An nam. Trong cuốn L’Art " +
                ...
                "Cô.");
        group3.getItems().add("“Bách cổ (100 món cổ vật) bao gồm bát bảo và bốn ngón mỹ thuật ‘cầm, kỳ, thi, họa’.");
        group3.getItems().add("“Bát bảo này có châu, kim tiền, cuốn thư (biểu tượng chiến thắng) , thư (sách), họa (bức " +
                "tranh), khánh ngọc, cặp chén rượu sừng tê giác, lá bối.”");
        group3.getItems().add("Còn phức tạp thêm khi thấy có bát bảo của Phật giáo: bánh xe pháp, tù và, bảo cái, bảo " +
                "tán, hoa sen, bình bát, mỏ, dây liên hoàn. Có khi còn có thêm chữ vạn, lư hương bốn chân, " +
                "một chữ cổ, cái chuông.");
        group3.getItems().add("Quả là vô ích khi muốn xác định bát bảo, ai cũng thấy vậy. Nhưng nó là một quan niệm " +
        ...
        group3.getItems().add(new Picture(R.drawable.p69, "Hình 69"));
        group3.getItems().add(new Picture(R.drawable.p70, "Hình 70"));
        List<Group> listLesson3 = new ArrayList();
        listLesson3.add(group3);
        lesson3.setGroups(listLesson3);
        lessons.add(lesson3);

        Lesson lesson4 = new Lesson("Bài 4: Họa tiết hoa, lá - dây lá và quả", R.drawable.p79);
        Group group4= new Group("");
        group4.getItems().add("Trong nghệ thuật trang trí của người An Nam, giới thực vật cũng được sử dụng với họa " +
                "tiết hoa, lá, dây là, và quả.");
        group4.getItems().add(new Picture(R.drawable.p74, "Hình 74"));
        group4.getItems().add("Lá là họa tiết trang trí đơn giản (hình LXXV, LXXIX), còn dây lá rườm rà và có kích " +
                ...
                "(hình LXXIV)");
        group4.getItems().add(new Picture(R.drawable.p75, "Hình 75"));
        group4.getItems().add(new Picture(R.drawable.p76, "Hình 76"));
        group4.getItems().add(new Picture(R.drawable.p77, "Hình 77"));
        group4.getItems().add(new Picture(R.drawable.p78, "Hình 78"));
        group4.getItems().add(new Picture(R.drawable.p79, "Hình 79"));
        group4.getItems().add("Chỉ thỉnh thoảng mới thấy họa tiết lá mang hình dáng tự nhiên (hình XCIII), còn thường " +
        ...
        group4.getItems().add(new Picture(R.drawable.p80, "Hình 80"));
        group4.getItems().add("Tên các họa tiết hoa lá thật khó xác định, ngay các nghệ sĩ An Nam cũng nhiều khi không " +
        ...
        group4.getItems().add(new Picture(R.drawable.p81, "Hình 81"));
        group4.getItems().add(new Picture(R.drawable.p82, "Hình 82"));
        group4.getItems().add(new Picture(R.drawable.p83, "Hình 83"));
        group4.getItems().add(new Picture(R.drawable.p84, "Hình 84"));
        group4.getItems().add(new Picture(R.drawable.p85, "Hình 85"));
        group4.getItems().add("Họa tiết thường dùng ở bờ mái nhà và mép đồ gỗ có tên ‘lá đề’, lá chẻ ba thùy và thùy " +
                ...
                "vật họ từng thấy.");
        group4.getItems().add(new Picture(R.drawable.p86, "Hình 86"));
        group4.getItems().add(new Picture(R.drawable.p87, "Hình 87"));
        group4.getItems().add(new Picture(R.drawable.p88, "Hình 88"));
        group4.getItems().add(new Picture(R.drawable.p89, "Hình 89"));
        group4.getItems().add(new Picture(R.drawable.p90, "Hình 90"));
        group4.getItems().add("Hoa đã cách điệu cũng khó định danh, khó lòng đặt tên khi ở trên cụm lá quy ước. Một " +
        ...
        group4.getItems().add(new Picture(R.drawable.p91, "Hình 91"));
        group4.getItems().add(new Picture(R.drawable.p92, "Hình 92"));
        group4.getItems().add(new Picture(R.drawable.p93, "Hình 93"));
        group4.getItems().add(new Picture(R.drawable.p94, "Hình 94"));
        group4.getItems().add(new Picture(R.drawable.p95, "Hình 95"));
        group4.getItems().add("Họa tiết ‘hoa đào’ (hình XII) chỉ có 4 cánh hơi nhọn ở đầu. Họa tiết ‘hoa mai’5 có năm " +
        ...
        group4.getItems().add("Chúng ta thấy hoa lá không thuần túy là họa tiết trang trí thôi, chúng còn là những biểu " +
        ...
        group4.getItems().add("Họa tiết cây cũng thường được biến cách theo truyền thống: nhánh mai hay nhánh đào " +
        ...
        group4.getItems().add("Có một loài hoa mà chúng ta chưa nhắc đến: ‘mẫu đơn’. Ở An Nam không có loài hoa " +
                ...
                "nhiên nào khác.");
        group4.getItems().add(new Picture(R.drawable.p96, "Hình 96"));
        group4.getItems().add(new Picture(R.drawable.p97, "Hình 97"));
        group4.getItems().add(new Picture(R.drawable.p98, "Hình 98"));
        group4.getItems().add(new Picture(R.drawable.p99, "Hình 99"));
        group4.getItems().add(new Picture(R.drawable.p100, "Hình 100"));
        group4.getItems().add("Nếu người nghệ sĩ giữ đúng truyền thống họa tiết, các loài hoa nói trên dễ thống nhất tên " +
        ...
        group4.getItems().add("Các loại trái cây các tay điêu khác và hội họa An Nam hay dùng có: lê, đào, phật thủ, lựu, " +
        ...
        group4.getItems().add("Phần lớn các hia quả đều mang một ý nghĩa biểu tượng. Đào là loài cây được coi có tính " +
        ...
        group4.getItems().add("Ở An Nam hiếm có cây đào nên các tục mê tín này ít thịnh hành. Nhưng người ta đưa cây " +
        ...
        group4.getItems().add("Quả lựu biểu tượng cho sự ‘con đàn cháu đống’ vì trong quả lựu có vô số hạt hồng hồng, " +
        ...
        group4.getItems().add("Sen cũng có biểu tượng giống như lựu vì trong búp sen có nhiều hạt. Thêm nữa, hoa sen " +
                "lại là biểu tượng của Phật giáo.");
        group4.getItems().add("Quả lê ở Trung Hoa cũng là biểu tượng cho đứa con do từ chữ ‘lê tử’ (quả lê) được trại ra " +
                "thành ‘lập tử’ (có con). Vì có sự phát âm khác nên biểu tượng này ít dùng ở An Nam.");
        group4.getItems().add("Ở Trung hoa quả dưa (qua 瓜) cũng được coi là biểu tượng đông con do quả dưa có nhiều " +
                "hạt. Biểu tượng này có thấy ở những bức chạm, nhưng hiếm thôi.");
        group4.getItems().add("Quả bầu có hai ngăn dùng chứa nước cũng thấy trên các tấm biển, nó là một trong ‘bát " +
        ...
        group4.getItems().add(new Picture(R.drawable.p101, "Hình 101"));
        group4.getItems().add(new Picture(R.drawable.p102, "Hình 102"));
        group4.getItems().add(new Picture(R.drawable.p103, "Hình 103"));
        group4.getItems().add(new Picture(R.drawable.p104, "Hình 104"));
        group4.getItems().add(new Picture(R.drawable.p105, "Hình 105"));
        group4.getItems().add(new Picture(R.drawable.p106, "Hình 106"));
        group4.getItems().add(new Picture(R.drawable.p107, "Hình 107"));
        group4.getItems().add(new Picture(R.drawable.p108, "Hình 108"));
        group4.getItems().add(new Picture(R.drawable.p109, "Hình 109"));
        group4.getItems().add("Trung Hoa coi mẫu đơn là nữ hoàng các loài hoa. Mẫu đơn đỏ tượng trưng cho sự hưởng " +
        ...
        group4.getItems().add("Bức tranh có hình cây tùng và con nai (tùng lộc) thường thấy trong các họa tiết trang trí " +
        ...
        group4.getItems().add("Phần sau chúng ta sẽ thấy theo truyền thống cổ xưa chúng ta sẽ thấy nhiều con thú được " +
                "kết hợp với nhiều loài thảo môc khác nhau.");
        group4.getItems().add("Đa số các trang trí dấu nhấn, nghĩa là các trang trí là bật lên độ cong của một đường nét " +
        ...
        group4.getItems().add(new Picture(R.drawable.p110, "Hình 110"));
        group4.getItems().add(new Picture(R.drawable.p111, "Hình 111"));
        group4.getItems().add(new Picture(R.drawable.p112, "Hình 112"));
        group4.getItems().add(new Picture(R.drawable.p113, "Hình 113"));
        group4.getItems().add(new Picture(R.drawable.p114, "Hình 114"));
        group4.getItems().add(new Picture(R.drawable.p115, "Hình 115"));
        group4.getItems().add(new Picture(R.drawable.p116, "Hình 116"));
        group4.getItems().add(new Picture(R.drawable.p117, "Hình 117"));
        group4.getItems().add("Trong số các trang trí này có một số thoát sinh từ mô-típ trang trí khác. Chẳng hạn mỏ cu " +
        ...
        group4.getItems().add("Hẳn nhiên hồi văn và họa tiết hình thú thuộc nhóm khác nhưng nói thêm ở đây vì có quá " +
        ...
        group4.getItems().add("Chủ đề dùng họa tiết dấu nhấn khá rộng, tựu trung có mấy quy tắc chính để theo.");
        group4.getItems().add("Đôi khi ở đầu chái nhà có trang trí mỏ neo. Hoặc là tương ứng với mỏ neo này trên gờ " +
        ...
        group4.getItems().add("Trong tranh trí cấp trung bình chúng ta thấy trên nóc mái có có long hay phụng; ở gờ các " +
        ...
        group4.getItems().add(new Picture(R.drawable.p118, "Hình 118"));
        List<Group> listLesson4 = new ArrayList();
        listLesson4.add(group4);
        lesson4.setGroups(listLesson4);
        lessons.add(lesson4);

        Lesson lesson5 = new Lesson("Bài 5: Họa tiết hình thú – con rồng", R.drawable.conrong);
        Group group5 = new Group("");
        group5.getItems().add("Trong số các con vật trang trí của người An Nam, bốn con vật siêu nhiên gọi là tứ linh " +
        ...
        group5.getItems().add("Con rồng tiếng Hán Việt là long (龍) rất được ưa dùng trang trí mỹ thuật An Nam. Trong " +
        ...
        group5.getItems().add("Theo truyền thuyết Trung Hoa rồng “có sừng hươu, đầu lạc đà, mắt quỷ, cổ rắn, bụng cá " +
        ...
        group5.getItems().add(new Picture(R.drawable.p119, "Hình 119"));
        group5.getItems().add(new Picture(R.drawable.p120, "Hình 120"));
        group5.getItems().add(new Picture(R.drawable.p121, "Hình 121"));
        group5.getItems().add("Như tôi đã nói rồng là biểu tượng của hoàng đế, ai cũng rõ trong trường hợp này rồng có " +
        ...
        group5.getItems().add(new Picture(R.drawable.p122, "Hình 122"));
        group5.getItems().add(new Picture(R.drawable.p123, "Hình 123"));
        group5.getItems().add(new Picture(R.drawable.p124, "Hình 124"));
        group5.getItems().add(new Picture(R.drawable.p125, "Hình 125"));
        group5.getItems().add(new Picture(R.drawable.p126, "Hình 126"));
        group5.getItems().add(new Picture(R.drawable.p127, "Hình 127"));
        group5.getItems().add("Rồng còn là biểu tượng cho người chồng, vị hôn phu, và thường hơn dùng để chỉ người " +
        ...
        group5.getItems().add(new Picture(R.drawable.p128, "Hình 128"));
        group5.getItems().add(new Picture(R.drawable.p129, "Hình 129"));
        group5.getItems().add(new Picture(R.drawable.p130, "Hình 130"));
        group5.getItems().add(new Picture(R.drawable.p131, "Hình 131"));
        group5.getItems().add(new Picture(R.drawable.p132, "Hình 132"));
        group5.getItems().add("Rồng được thể hiện bằng nhiều cách khác nhau. Khi thì là hình nguyên con rồng nhìn " +
        ...
        group5.getItems().add(new Picture(R.drawable.p133, "Hình 133"));
        group5.getItems().add(new Picture(R.drawable.p134, "Hình 134"));
        group5.getItems().add(new Picture(R.drawable.p135, "Hình 135"));
        group5.getItems().add(new Picture(R.drawable.p136, "Hình 136"));
        group5.getItems().add(new Picture(R.drawable.p137, "Hình 137"));
        group5.getItems().add("Trên gờ nóc mái, rồng được thể hiện dạng kỷ hà hai con (song long) ở hai đầu gờ. Ở giữa " +
        ...
        group5.getItems().add("Một thể hiện gần gủi với nó là ‘lưỡng long tranh châu’ theo cách gọi của người An Nam. " +
                ...
                "CXXI và CXXXIII).");
        group5.getItems().add(new Picture(R.drawable.p139, "Hình 139"));
        group5.getItems().add(new Picture(R.drawable.p140, "Hình 140"));
        group5.getItems().add(new Picture(R.drawable.p141, "Hình 141"));
        group5.getItems().add("Nếu có điều kiện, dù trong chủ đề nào con rồng cũng có mây bao quanh, mây có dạng trãi " +
        ...
        group5.getItems().add("Trang trí mây cũng cho ra một thể hiện đặc biệt gọi là ‘long ẩn vân’ (rồng ẩn trong mây); " +
                "rồng uốn khúc trong các guột mây và lần lượt lộ ra từng phần con rồng. Nhiều chén gốm " +
                "đời Thiệu Trị có mô-típ này.");
        group5.getItems().add("Rồng kết hợp với cá cho ra ‘ngư long hí thủy’ nghĩa là rồng và cá đùa nước (hình " +
        ...
        group5.getItems().add("Không phải chỉ có một con vật duy nhất gọi là rồng. Ngoài con rồng đúng nghĩa còn thấy " +
                "có con giao và con cù.");
        group5.getItems().add("Theo từ điển của P. Couvreur con giao hay giao long là ‘rồng không sừng’ mang dáng " +
                ...
                "‘con cá sấu’.");
        group5.getItems().add(new Picture(R.drawable.p142, "Hình 142"));
        group5.getItems().add("Con cù hay cù long cũng mơ hồ không kém. Couvreur thì nói đó là ‘con rồng có sừng’, " +
        ...
        group5.getItems().add("Các nghệ sĩ An Nam thì xác định một điều: cả giao lẫn cù đều không có sừng. Chúng " +
        ...
        group5.getItems().add("Tuy nhiên phải thừa nhận người ta hay pha trộn con rồng thông thường với con giao " +
        ...
        group5.getItems().add(new Picture(R.drawable.p143, "Hình 143"));
        group5.getItems().add(new Picture(R.drawable.p144, "Hình 144"));
        group5.getItems().add(new Picture(R.drawable.p145, "Hình 145"));
        group5.getItems().add(new Picture(R.drawable.p146, "Hình 146"));
        group5.getItems().add(new Picture(R.drawable.p147, "Hình 147"));
        group5.getItems().add(new Picture(R.drawable.p148, "Hình 148"));
        group5.getItems().add(new Picture(R.drawable.p149, "Hình 149"));
        group5.getItems().add(new Picture(R.drawable.p150, "Hình 150"));
        group5.getItems().add(new Picture(R.drawable.p151, "Hình 151"));
        group5.getItems().add("Đối với con cù, nó có nét chuyên biệt, nếu không ở hình dáng hay và thuộc tính thì cũng " +
                ...
                "rồng.");
        group5.getItems().add("Rồng nguyên con, hoặc là rồng đích thực hay con giao, thường là hồi văn hóa long (hình " +
                ...
                "kèn8, … (hình CLV)");
        group5.getItems().add("Rồng chính diện biến cách gọi là ‘mặt nả’. Người ta hay giải thích mặt nả có nghĩa là mặt " +
        ...
        group5.getItems().add(new Picture(R.drawable.p152, "Hình 152"));
        group5.getItems().add(new Picture(R.drawable.p153, "Hình 153"));
        group5.getItems().add(new Picture(R.drawable.p154, "Hình 154"));
        List<Group> listLesson5 = new ArrayList();
        listLesson5.add(group5);
        lesson5.setGroups(listLesson5);
        lessons.add(lesson5);

        Lesson lesson6 = new Lesson("Bài 6: Họa tiết hình thú – con lân", R.drawable.p155);
        Group group6 = new Group("");
        group6.getItems().add("Khi người An Nam nói đến kỳ lân thì họ nghĩ đó là một từ duy nhất, nhưng theo các từ " +
                ...
                "hay con cái.");
        group6.getItems().add("Từ điển của Gibrel ghi: Kỳ lân, “licorne, sphinx” (ngựa một sừng, nhân sư) và chua thêm: " +
        ...
        group6.getItems().add("Từ điển của Paulus Của nói cần phận biệt rõ kỳ là con đực và lân là con cái, Nhưng ông " +
                ...
                "khí vô hại.");
        group6.getItems().add("Từ điển tiếng Hoa của Giles, Eitel, Couvreur cho những thông tin sau: Kỳ lân là con vật " +
        ...
        group6.getItems().add("Chi tiết này dù thế nào đi nữa thì kỳ lân có tính nhân hậu như trong truyền thuyết: con vật " +
                "này chẳng bao giờ đi trên sinh vật sống và chẳng bao giờ ăn cỏ tươi; sừng của nó là biểu " +
                "tượng cho lòng yêu hòa bình.");
        group6.getItems().add("“Dấu chân của Kỳ lân” dùng chỉ nòi giống vua chúa, và “lân giác” chỉ hoàng thái tử. " +
        ...
        group6.getItems().add("Còn đây là lời chú thêm của P. Corentin Pétillon 13 : Sự xuất hiện của kỳ lân báo hiệu sự ra " +
        ...
        group6.getItems().add("Khổng Tử rơi lệ là vì khi ngài đản sinh có con kỳ lân xuất hiện mang đến nhà ngài tấm " +
        ...
        group6.getItems().add("Như tôi đã nói người An Nam quen gọi lân hay kỳ lân, nhưng cũng có khi lại gọi là long " +
                ...
                "không vậy.");
        group6.getItems().add(" Kỳ lân được dùng làm họa tiết trang trí trên các bình phong trong các đền chùa (hình " +
        ...
        group6.getItems().add("Hình vua thấy đầu tiên đó họi là Hà Đồ (bứcvẽ trên sông Hoàng Hà). Một truyền thuyết " +
                "khác về bát quái nói vua Hoàng Đế lấy từ lưng con rùa.");
        group6.getItems().add("Dù gì trên các bức bình phong hình con lân thỉnh thoảng có mang trên lưng bánh xe tám " +
                ...
                "hóa của muôn vật.");
        group6.getItems().add(new Picture(R.drawable.p155, "Hình 155"));
        group6.getItems().add(new Picture(R.drawable.p156, "Hình 156"));
        group6.getItems().add(new Picture(R.drawable.p157, "Hình 157"));
        group6.getItems().add(new Picture(R.drawable.p158, "Hình 1548"));
        group6.getItems().add(new Picture(R.drawable.p159, "Hình 159"));
        group6.getItems().add("Cổ đồ luôn luôn trang trí thêm dãi lụa, đặt trên tấm thảm rồi mới để lên lưng kỳ lân. Sau " +
        ...
        group6.getItems().add("Đôi khi chúng ta cũng thấy kỳ lân được dùng như loại trang trí dấu nhấn, nhưng lúc này " +
                "phụ vào con rồng hay con phụng. Bấy giồ lân được xuất hiện ở đầu rìa với tư thế không " +
                "phóng khoáng cho lắm (hình CLVIII).");
        group6.getItems().add(new Picture(R.drawable.p160, "Hình 160"));
        group6.getItems().add(new Picture(R.drawable.p161, "Hình 161"));
        group6.getItems().add("Một con vật rất giống nhưng không phải là kỳ lân, đó là con sư tử, nhưng cũng được " +
        ...
        group6.getItems().add("Còn trong biến cách, kỳ lân thường được hóa ra từ nhánh mẫu đơn gọi là mẫu đơn hóa " +
        ...
        group6.getItems().add(new Picture(R.drawable.p162, "Hình 162"));
        group6.getItems().add(new Picture(R.drawable.p163, "Hình 163"));
        List<Group> listLesson6 = new ArrayList();
        listLesson6.add(group6);
        lesson6.setGroups(listLesson6);
        lessons.add(lesson6);

        Lesson lesson7 = new Lesson("Bài 7: Họa tiết hình thú – con phụng", R.drawable.p164);
        Group group7 = new Group("");
        group7.getItems().add("Hình CLXIV cho một ý tưởng về các phẩm chất của một con chim phụng, bức hình này " +
        ...
        group7.getItems().add("Cánh nó vươn rộng với những cọng lông cứng mà người ta nói cúng như thép, lông đuôi " +
        ...
        group7.getItems().add(new Picture(R.drawable.p164, "Hình 164"));
        group7.getItems().add(new Picture(R.drawable.p165, "Hình 165"));
        group7.getItems().add(new Picture(R.drawable.p166, "Hình 166"));
        group7.getItems().add(new Picture(R.drawable.p167, "Hình 167"));
        group7.getItems().add("Theo truyền thuyết Trung Hoa, chim phụng có nhiều phẩm hạnh cao đẹp: “tiếng hót ngân " +
        ...
        group7.getItems().add("mình khi thời loạn lạc. Nên phụng là biểu tượng cho thái bình. " +
        ...
        group7.getItems().add("Hình ảnh chim phụng dành chỉ người phụ nữ. Chính vì vậy phụng thường trang trí ở các " +
        ...
        group7.getItems().add("Loài chim này có hai tên gọi: con trống gọi là phụng và con mái gọi là hoàng; gộp lại gọi " +
        ...
        group7.getItems().add(new Picture(R.drawable.p168, "Hình 168"));
        group7.getItems().add(new Picture(R.drawable.p169, "Hình 169"));
        group7.getItems().add(new Picture(R.drawable.p170, "Hình 170"));
        group7.getItems().add(new Picture(R.drawable.p171, "Hình 171"));
        group7.getItems().add("Còn về tổng quan chom phụng là biểu tượng thái bình như đã nói ở trên. Nên trong cung " +
                "điện cũng có hình chim phụng để phỉnh nịnh ca tụng vua chúa đang sống thời thái bình " +
                "thịnh trị vì có chim phụng xuất thế.");
        group7.getItems().add("Như tôi đã trình bày, trong kiến trúc hình ảnh chim phụng được dùng làm trang trí dấu " +
        ...
        group7.getItems().add("Phụng còn có những biến cách (hóa), thường nhất là đào hóa phụng, nhưng cũng thấy " +
        ...
        group7.getItems().add("Ở Bắc Kỳ, trước các ngôi đền thường thấy bốn chim phụng không đuôi trên các đỉnh cột. " +
        ...
        group7.getItems().add("Có một con chim tương tự khác gọi là hạc. Lưu ý là hình dáng hạc với phụng, cũng như " +
        ...
        group7.getItems().add("Hình như theo người Trung Hoa có hạc đen, hạc vàng và hạc xanh nữa, nhưng người An " +
        ...
        group7.getItems().add("Thêm nữa, hạc là vật cưỡi của chư tiên, đuều này được đánh đồng là chúng trường sinh " +
        ...
        group7.getItems().add(new Picture(R.drawable.p172, "Hình 172"));
        group7.getItems().add(new Picture(R.drawable.p173, "Hình 173"));
        group7.getItems().add(new Picture(R.drawable.p174, "Hình 174"));
        group7.getItems().add(new Picture(R.drawable.p175, "Hình 175"));
        List<Group> listLesson7 = new ArrayList();
        listLesson7.add(group7);
        lesson7.setGroups(listLesson7);
        lessons.add(lesson7);

        Lesson lesson8 = new Lesson("Bài 8: Họa tiết hình thú – con rùa", R.drawable.p176);
        Group group8 = new Group("");
        group8.getItems().add("Rùa, tiếng Hán Việt là quy (龜), là một trong tứ linh, biểu tượng cho sự trường thọ vì nó " +
        ...
        group8.getItems().add("Vì mai rùa ở trên tròn nên được coi là tượng của trời, ở dưới dẹt tượng của đất, nên rùa ví " +
        ...
        group8.getItems().add("Ở Trung Hoa người ta tin rằng rùa cái thường giao phối với con rắn, nên thường cho đó " +
        ...
        group8.getItems().add("Vì rùa có dáng nặng nề nên được cho là biểu tượng của sự vững trãi nên ở Trung Hoa rùa " +
                "được thờ làm thần hộ đê.");
        group8.getItems().add("Người An Nam hình như không quan tâm những biểu tượng đó, rùa được dùng làm đế " +
                "bia với tín ngưỡng tin vào sự trường thọ, cũng như tin vào sự vững bền như biểu hiện " +
                "nặng nề nơi cơ thể nó (hình CLXXVII).");
        group8.getItems().add(new Picture(R.drawable.p176, "Hình 176"));
        group8.getItems().add(new Picture(R.drawable.p177, "Hình 177"));
        group8.getItems().add("Người ta cũng thấy rùa làm trang trí dấu nhấn ở gờ bên mái nhà, nhưng trường hợp này " +
        ...
        group8.getItems().add(new Picture(R.drawable.p178, "Hình 178"));
        group8.getItems().add(new Picture(R.drawable.p179, "Hình 179"));
        List<Group> listLesson8 = new ArrayList();
        listLesson8.add(group8);
        lesson8.setGroups(listLesson8);
        lessons.add(lesson8);

        Lesson lesson9 = new Lesson("Bài 9: Họa tiết hình thú – con dơi", R.drawable.p192);
        Group group9 = new Group("");
        group9.getItems().add("Dơi có vai trò lớn trong nghệ thuật trang trí An Nam, nó biểu tượg cho chữ ‘phúc’. Là do " +
        ...
        group9.getItems().add(new Picture(R.drawable.p180, "Hình 180"));
        group9.getItems().add(new Picture(R.drawable.p181, "Hình 181"));
        group9.getItems().add(new Picture(R.drawable.p182, "Hình 182"));
        group9.getItems().add(new Picture(R.drawable.p183, "Hình 183"));
        group9.getItems().add(new Picture(R.drawable.p184, "Hình 184"));
        group9.getItems().add(new Picture(R.drawable.p185, "Hình 185"));
        group9.getItems().add("Cùng với hình ảnh con dơi các họa tiết thường có lối chơi chữ. Thường nhất là lối chơi " +
        ...
        group9.getItems().add(new Picture(R.drawable.p186, "Hình 186"));
        group9.getItems().add(new Picture(R.drawable.p187, "Hình 187"));
        group9.getItems().add(new Picture(R.drawable.p188, "Hình 188"));
        group9.getItems().add(new Picture(R.drawable.p189, "Hình 189"));
        group9.getItems().add(new Picture(R.drawable.p190, "Hình 190"));
        group9.getItems().add("Hoặc cũng có khi đi với chữ ‘thọ’, thành ra ‘phúc thọ’, tức cầu chúc vừa hưởng phúc vừa " +
        ...
        group9.getItems().add("Thay cho khánh ngọc hay chữ thọ, con thấy hình con dơi ngậm một giõ hoa. Giõ hoa là " +
                ...
                "CLXXXI, …)");
        group9.getItems().add("Dơi có thể được biến cách từ lá, họi là lá hóa phúc, từ hoa mai gọi là mai hóa phúc, từ " +
        ...
        group9.getItems().add(new Picture(R.drawable.p191, "Hình 191"));
        group9.getItems().add(new Picture(R.drawable.p192, "Hình 192"));
        group9.getItems().add(new Picture(R.drawable.p193, "Hình 193"));
        List<Group> listLesson9 = new ArrayList();
        listLesson9.add(group9);
        lesson9.setGroups(listLesson9);
        lessons.add(lesson9);

        Lesson lesson10 = new Lesson("Bài 10: Họa tiết hình thú – sư tử", R.drawable.p197);
        Group group10 = new Group("");
        group10.getItems().add("Trong mỹ thuật An Nam sư tử có hai tên: sư và nghê. Đầu tiên nói đến con sư tử có bờm " +
        ...
        group10.getItems().add("Mô-típ này thường dùng trang trí các góc: con sư tử có dáng như bước xuống thềm cửa, " +
        ...
        group10.getItems().add("Đôi lúc thấy trên bình phong có trang trí hình 5 con sư tử gọi là ngũ sư hí cầu (hình " +
        ...
        group10.getItems().add("Hình thái khác của con sư tử là con nghê hay toan nghê 22 (hình CXCVII). Cả từ điển " +
        ...
        group10.getItems().add("Con nghê được trang trí ở Điện Thái Hòa, hai con đặt hai bên điện. Con vật này bằng " +
                ...
                "cỡ đó. (hình CXCVII)");
        group10.getItems().add(new Picture(R.drawable.p194, "Hình 194"));
        group10.getItems().add(new Picture(R.drawable.p195, "Hình 195"));
        group10.getItems().add(new Picture(R.drawable.p196, "Hình 196"));
        group10.getItems().add(new Picture(R.drawable.p197, "Hình 197"));
        List<Group> listLesson10 = new ArrayList();
        listLesson10.add(group10);
        lesson10.setGroups(listLesson10);
        lessons.add(lesson10);

        Lesson lesson11 = new Lesson("Bài 11: Họa tiết hình thú – con cọp", R.drawable.p198);
        Group group11 = new Group("");
        group11.getItems().add("Tác giả không có bài viết, chỉ minh họa một số hình.");
        group11.getItems().add(new Picture(R.drawable.p198, "Hình 198"));
        group11.getItems().add(new Picture(R.drawable.p199, "Hình 199"));
        List<Group> listLesson11 = new ArrayList();
        listLesson11.add(group11);
        lesson11.setGroups(listLesson11);
        lessons.add(lesson11);

        Lesson lesson12 = new Lesson("Bài 12: Họa tiết hình thú – con cá", R.drawable.p202);
        Group group12 = new Group("");
        group12.getItems().add("Ở Trung Hoa, chữ ngư 漁 (con cá) phát âm giống chữ dư 輿 (dư thừa). Do vậy hình ảnh " +
                "con cá biểu tượng cho sự trù phú, thường vẽ thành hình một đứa bé cầm con cá với nghĩa " +
                "“Phú, hữu dư” (giàu, có dư).");
        group12.getItems().add("Ở An Nam không thể có lối chơi chữ này vì chữ “cá” và chữ “dư” không trùng âm. " +
        ...
        group12.getItems().add("Ở Bắc Kỳ trong các đền chùa thảy đều thấy hình con cá ở các gờ mái như loại trang trí " +
        ...
        group12.getItems().add(new Picture(R.drawable.p200, "Hình 200"));
        group12.getItems().add(new Picture(R.drawable.p201, "Hình 201"));
        group12.getItems().add(new Picture(R.drawable.p202, "Hình 202"));
        group12.getItems().add("Con cá làm thành hình miệng máng xối có nét tự nhiên vì được hiểu nước là một yếu tố " +
                ...
                "tế hơn.");
        group12.getItems().add("Cá ngoài biểu tượng cho sự giàu sang như đã nói, nó còn là biểu tượng cho sự đăng khoa " +
                ...
                "hóa thành rồng.");
        group12.getItems().add(new Picture(R.drawable.p203, "Hình 203"));
        group12.getItems().add(new Picture(R.drawable.p204, "Hình 204"));
        group12.getItems().add(new Picture(R.drawable.p205, "Hình 205"));
        List<Group> listLesson12 = new ArrayList();
        listLesson12.add(group12);
        lesson12.setGroups(listLesson12);
